"""
Django settings for sitetickets project.
...
SECRET_KEY = 'django-insecure-1%b20_ok0y*7^vkk=3s*dpz6*vt&8)ucnorksx+fs)g^uya4ry'
...
INSTALLED_APPS = [
    ...
    'events.apps.EventsConfig', # adicione esta linha
...
WSGI_APPLICATION = 'sitetickets.wsgi.application'
